      ...
      <div class="md:hidden border-t border-gray-200 py-4">
        ...
        <nav class="space-y-1">
          {#each navItems as item}
            <a
              href={item.href}
              class="block px-4 py-2 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-colors duration-200 {$page.url.pathname === item.href ? 'text-blue-600 bg-blue-50' : ''}"
        ...
        <!-- Mobile Auth Buttons -->
        <div class="px-4 pt-4 border-t border-gray-200 mt-4 space-y-2 sm:hidden">
