	...
	<Card>
		<div class="p-6">
			...
			<p class="text-gray-600 mb-6">
				Calculate your Body Mass Index (BMI) to assess if your weight is
				in a healthy range.
			</p>
		...
		<Card>
			<div class="p-6">
				...
				<div class="text-center mb-6">
					...
					<div
						class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border {getCategoryColor(
							category,
						)}"
					>
						{category}
				...
				<div class="mb-6">
					...
					<div class="space-y-2">
						<div
							class="flex items-center justify-between p-3 rounded-lg {category ===
							'Underweight'
				...
				<div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
					...
					<p class="text-blue-800 text-sm">
						BMI is a useful screening tool, but it doesn't directly
						measure body fat or account for muscle mass, bone
						density, and other factors. Consult with a healthcare
