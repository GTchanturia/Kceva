    ...
    <Card>
        <div class="p-6">
            ...
            <p class="text-gray-600 mb-6">
                ...
                formats. Perfect for programming, computer science, and digital
                electronics.
            </p>
    ...
    {#if showResults && !error}
        <Card>
            <div class="p-6 text-center">
                ...
                <div class="text-lg text-gray-600">Decimal</div>
            </div>
        </Card>
            ...
            <div class="p-6">
                ...
                >
                    ...
                    <p class="text-blue-800 text-sm">
                        Each digit represents a power of 2, starting from 2⁰ on
                        the right.
                    </p>
                </div>
