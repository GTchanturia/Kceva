...
// Maps calculator id -> Svelte component for rendering.
...
import CreditCardPayoffCalculator from "$lib/calculators/Finance/CreditCardPayoffCalculator.svelte";
import MarkupMarkdownCalculator from "$lib/calculators/Finance/MarkupMarkdownCalculator.svelte";
...
import BloodAlcoholCalculator from "$lib/calculators/Health/BloodAlcoholCalculator.svelte";
...
import DecimalToFractionConverter from "$lib/calculators/Math/DecimalToFractionConverter.svelte";
...
import AspectRatioCalculator from "$lib/calculators/Design/AspectRatioCalculator.svelte";
