    ...
    <Card>
        <div class="p-6">
            ...
            <p class="text-gray-600 mb-6">
                Convert any decimal number to its fraction equivalent.
                Automatically simplifies fractions and shows mixed number format
                when applicable.
            </p>
                ...
                <div class="mb-4">
                    ...
                    {#if mixedNumber && mixedNumber.numerator > 0}
                        <div class="text-lg text-gray-600">
                            Mixed Number: {mixedNumber.whole}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600"
                                >Simplified Fraction:</span
                            >
                            <span class="font-semibold text-blue-600"
                                >{simplifiedNumerator}/{simplifiedDenominator}</span
                            >
                        </div>
                        {#if mixedNumber && mixedNumber.numerator > 0}
                            <div class="flex justify-between">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold"
                                >{formatNumber(decimal * 100, 2)}%</span
                            >
                        </div>
                    </div>
                </div>
        ...
        <Card>
            <div class="p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {#each [{ dec: "0.5", frac: "1/2" }, { dec: "0.25", frac: "1/4" }, { dec: "0.75", frac: "3/4" }, { dec: "0.125", frac: "1/8" }, { dec: "0.2", frac: "1/5" }, { dec: "0.1", frac: "1/10" }, { dec: "0.333", frac: "1/3" }, { dec: "0.667", frac: "2/3" }] as common}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <p class="text-blue-800 text-sm">
                            To convert a decimal to a fraction: count decimal
                            places, use as denominator power of 10, then
                    ...
                    >
                        ...
                        <p class="text-green-800 text-sm">
                            ...
                            the fraction can be written as a mixed number (whole
                            number + fraction).
                        </p>
                    </div>
                </div>
