            ...
            <div class="p-6 text-center">
                <div class="mb-4">
                    <div class="text-2xl text-gray-600 mb-2">
                        {getCurrencySymbol(fromCurrency)}{formatNumber(
                            amount,
                            2,
                        )}
                        {fromCurrency}
                ...
                <div class="text-gray-600">
                    ...
                    <div class="text-lg font-semibold">
                        1 {fromCurrency} = {formatNumber(exchangeRate, 6)}
                        {toCurrency}
                    </div>
                </div>
            </div>
                            ...
                            {#each [1, 5, 10, 25, 50, 100, 500, 1000] as qty}
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium"
                                        >{formatNumber(qty * exchangeRate, 2)}
                                        {toCurrency}</span
                                    >
                                </div>
                            {/each}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <p class="text-blue-800 text-sm">
                            Exchange rates are updated daily and may vary from
                            real-time market rates. Rates shown are mid-market
                            rates for reference purposes.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p class="text-yellow-800 text-sm">
                            Banks and money transfer services typically charge
                            fees and offer different rates. Check with your
                            financial institution for actual exchange rates.
                        </p>
                    </div>
                </div>
            </div>
